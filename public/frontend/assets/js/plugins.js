...
(function (t, s) {
    s.fn.themePin = function (t) {
        var o = 0, e = 0, i = [], a = !1, n = s(window), p = [], r = [];
        t = t || {};
        var c = function () {
            for (var o = 0, e = i.length; o < e; o++) {
                ...
                if (t.minWidth && n.width() <= t.minWidth) p.parent().is(".pin-wrapper") && p.unwrap(), p.css({
                    ...
                    top: "",
                    position: ""
                }), t.activeClass && p.removeClass(t.activeClass), p.removeClass("sticky-transition"), p.removeClass("sticky-absolute"), a = !0; else {
                    a = !1;
                    ...
                    if (void 0 !== l) {
                        ...
                        var m = p.css("border-bottom"), v = p.outerHeight();
                        p.css("border-bottom", "1px solid transparent");
                        var C = p.outerHeight() - v - 1;
                        p.css("border-bottom", m), p.css({width: p.outerWidth() <= p.parent().width() ? p.outerWidth() : p.parent().width()}), p.parent().css("height", p.outerHeight() + C), !t.autoFit && !t.fitToBottom || p.outerHeight() <= n.height() ? p.data("themePin", {
                            pad: f,
            ...
            if (!a) {
                ...
                for (var c = window.innerHeight || n.height(), l = 0, d = i.length; l < d; l++) {
                    var f, h = s(i[l]), u = h.data("themePin"), m = u.to;
                    if (u) {
                        ...
                        if (u.end = v.offset().top + v.height(), C ? u.to = v.offset().top + v.height() - h.outerHeight() - u.pad.bottom - u.pb : (u.to = v.offset().top + v.height() - c - u.pb, u.to2 = v.height() - h.outerHeight() - u.pad.bottom - u.pb), C) {
                            var b = u.from - u.pad.bottom, g = u.to - u.pad.top - u.offset;
                            ...
                            position: "fixed",
                            top: u.pad.top
                        }) : h.css({position: "", top: "", bottom: "", left: ""}), p[l] = r[l] = !1
                    }
                }
                e = o
            }
        ...
        return this.each(function () {
            var t = s(this), o = s(this).data("themePin") || {};
    ...
    o.defaults = {
        ...
        initialize: function (t, s) {
            ...
            return this.options = s.extend(!0, {}, o.defaults, t, {wrapper: this.$el}), this
        }, build: function () {
    ...
    }, s.extend(t, {Sticky: o}), s.fn.themeSticky = function (o) {
