                    ...
                    <div class="page-head">
                        <div class="container">
                            ...
                            <div class="page-title">
                                <h1>{{ __('dashboard.Wallet Transfer - Merchant') }}
                                </h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row" style="margin: 0">
                            ...
                            <div class="col-md-6 portlet light">
                                <h4> {{__('dashboard.Merchant')}} <br><i class="fa fa-qrcode"></i> {{__('dashboard.Qr code')}}</h4>
                                <br>
                                <script>
                                    var qr_scan_url = "{!! route('qr-check-merchant') !!}";
                                </script>
                            ...
                            <div class="col-md-6">
                                <div class="form-body">
                                    {{ Form::open([
                                    'url' => 'merchant/payment/wallet-transfer/merchant',
                                    'class' => 'horizontal-form ajax-post-merchant-transfer',
                                    'method'=> 'POST'
                                    ])   }}
                                    <h3 class="form-section">{{__('dashboard.Wallet Transfer - Merchant')}}</h3>
                                ...
                                <button id="genmerchant1" class="btn btn-success" type="button">
