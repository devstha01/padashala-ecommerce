                    ...
                    <div class="page-head">
                        <div class="container">
                            ...
                            <div class="page-title">
                                <h1>{{ __('dashboard.Payment Request') }}
                                </h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row" style="margin: 0">
                            ...
                            <div class="col-md-6">
                                <div class="form-body">
                                    {{ Form::open([
                                    'url' => 'merchant/payment/payment-request/',
                                    'class' => 'horizontal-form ajax-post-merchant-payment',
                                    'method'=> 'POST'
                                    ])   }}
                                    <h3 class="form-section">{{__('dashboard.Payment Request')}}</h3>
...
@section('scripts')
    <script>
        $('#are-you-sure-btn').on('click', function () {
            ...
            $('#are-you-sure-message').html('Payment request amount $' + amount + ' from ' + from);
        });
    </script>
@endsection
