                            ...
                            <div class="tabbable-custom nav-justified">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane {{(session('active')!==null)?'':'active'}}" id="tab_1_1_1">
                                        <form action="{{route('edit-product-ch-merchant-post',$product->id)}}"
                                              method="post"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="detail"
                                                          style="resize: none">{{$ch_product->detail??''}}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="description"
                                                          style="resize: none">{{$ch_product->description??''}}</textarea>
                                    ...
                                    <div class="tab-pane {{(session('active') === 'variant')?'active':''}}"
                                        ...
                                        <table class="table tabl-striped">
                                            ...
                                            @forelse($product->getProductVariant as $key=>$variant)
                                                <tr>
                                                    <form action="{{route('edit-product-variant-ch-merchant')}}" method="post">
                                                        <td>{{++$key}}</td>
                                                        <td>{{$variant->name}}</td>
                                                        <td>
                                                            {{csrf_field()}}
                                                            ...
                                                            <input type="text" name="name"
                                                                   class="form-control"
                                                                   value="{{$variant->getChineseName->name??''}}">
                                                        </td>
                                                        <td>
