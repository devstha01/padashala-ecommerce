                                            ...
                                            <form action="{{route('admin-item-status-change',$item->id)}}"
                                                ...
                                                <td class="select-status">
                                                    <select name="payment_status"
                                                        ...
                                                        <option value="unpaid" {{$item->payment_status =='unpaid'?'selected':''}}>
                                                            unpaid
                                                        </option>
                                                ...
                                                <td class="select-status">
                                                    @if($item->order_status_id !='deliver')
                                                        <select name="order_status" class="form-control">
                                                            <option value="process" {{$item->order_status_id =='process'?'selected':''}}>
                                                                Processing
                                                            </option>
                                                            <option value="dispatch" {{$item->order_status_id =='dispatch'?'selected':''}}>{{__('dashboard.Dispatched')}}</option>
                                                            <option value="deliver" {{$item->order_status_id =='deliver'?'selected':''}}>{{__('dashboard.Delivered')}}</option>
                                                        </select>
                                                    @else
                                                        <i class="badge badge-info">{{$item->getOrderStatus->name}}</i>
                                                    @endif
