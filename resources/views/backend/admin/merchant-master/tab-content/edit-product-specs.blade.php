                    ...
                    <div class="portlet light">
                        <div class="portlet-body">
                            ...
                            <ul class="nav nav-justified">
                                <li class="">
                                    <a href="{{route('admin-edit-product',$product->slug)}}"> {{__('dashboard.General')}} </a>
                                </li>
                                <li class="">
                            ...
                            <div>
                                <table class="table table-borderless">
                                    ...
                                    @forelse($product->specifications as $specification)
                                        <tr>
                                            <form action="{{route('update-specs-product-admin',$specification)}}" method="post">
                                                {{csrf_field()}}
                                            <td>
                                            ...
                                            <td>
                                                <form action="{{route('delete-spec-product-admin',$specification->id)}}" method="post">
                                                    {{csrf_field()}}
                                    ...
                                    @endforelse
                                    <tr>
                                        <form action="{{route('add-specs-product-admin',$product->id)}}" method="post">
                                            {{csrf_field()}}
