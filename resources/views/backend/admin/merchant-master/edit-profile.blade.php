                            ...
                            <div class="page-content-inner">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        {{--@include('fragments.merchant.left-part-admin')--}}
                                                        ...
                                                        <div class="portlet-body">
                                                            ...
                                                            <div class="tab-content">
                                                                ...
                                                                <div class="tab-pane {{empty(session('edit-profile-merchant'))?'active':''}}"
                                                                    ...
                                                                    <form action="{{route('submit-merchant-profile-edit',$merchant->id)}}"
                                                                          method="post"
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label class="control-label">{{__('dashboard.Business Name')}}</label>
                                                                                    <input type="text"
                                                                                           class="form-control"
                                                                                           name="business_name"
                                                                                           placeholder=""
                                                                ...
                                                                <div class="tab-pane {{(session('edit-profile-merchant') === 'documents')?'active':''}}"
                                                                    ...
                                                                    <form action="{{route('admin-submit-doc',$merchant->id)}}"
                                                                          method="post"
                                                                          enctype="multipart/form-data">
                                                                        {{csrf_field()}}
                                                                        <div class="row">
                                                                ...
                                                                <div class="tab-pane {{(session('edit-profile-merchant') === 'pass')?'active':''}}"
                                                                    ...
                                                                    <div class="row">
                                                                        <form action="{{route('submit-merchant-pass',$merchant->id)}}"
                                                                              method="post">
                                                                            {{csrf_field()}}
                                                                            <div class="col-md-6">
                                                                                <h5>{{__('dashboard.Login Password')}}</h5>
