                    ...
                    <div class="page-head">
                        <div class="container">
                            ...
                            <div class="page-title">
                                <h1> {{__('dashboard.Merchant Cash Withdrawal Request')}}
                                </h1>
                            </div>
                                            ...
                                            <div class="portlet-body box-body">
                                                ...
                                                <div class="table-reponsive table-scrollable">
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            <th>S.No.</th>
                                                            <th>{{__('dashboard.Merchant Id')}}</th>
                                                        ...
                                                        @foreach ($merchants as $key=>$merchant)
                                                            <tr>
                                                                ...
                                                                <td>{{$merchant->getUser->user_name}}</td>
                                                                <td>{{$merchant->contact_number}}</td>
                                                                <td>{{$merchant->amount}}</td>
                                                                <td>{{$merchant->bank_name}}</td>
                                                                <td>{{$merchant->acc_name}}</td>
                                                                <td>{{$merchant->acc_number}}</td>
                                                                <td>{{$merchant->remarks}}</td>
                                                                <td>{{$merchant->status}}</td>
                                                                <td>
                                                                    <button type="button" class="btn btn-primary"><a
                                                                                href="{{route('admin-merchant-cash-withdraw-accept',$merchant->id)}}">{{__('dashboard.Accept')}}</a>
                                                                    </button>
                                                                </td>
