                    ...
                    <div class="page-head">
                        <div class="container">
                            ...
                            <div class="page-title">
                                <h1> {{__('dashboard.Member Wallet Converts Report')}}
                                </h1>
                            </div>
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover dataTable dtr-inline"
                                ...
                                <tr>
                                    ...
                                    <th>{{__('dashboard.From Wallet Id')}}</th>
                                    <th>{{__('dashboard.To Wallet Id')}}</th>
                                ...
                                @foreach($reports as $key=>$report)
                                    <tr>
                                        ...
                                        <td>{{$report->getFromWallet->detail}}</td>
                                        <td>{{$report->getToWallet->detail}}</td>
                                        <td>{{$report->amount}}</td>
                                        <td>{{$report->remarks}}
                                    </tr>
                                @endforeach
