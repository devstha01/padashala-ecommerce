                    ...
                    <div class="container">
                        ...
                        <div class="portlet light">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <canvas id="merchant_chart" class="chart"
...
@section('scripts')
    ...
    <script>
        ...
        var merchant_chart = document.getElementById('merchant_chart').getContext('2d');
        var merchant_data = {!! json_encode($byMerchants) !!};
        var myChart1 = new Chart(merchant_chart, {
            type: 'horizontalBar',
            data: {
                labels: merchant_data.name,
                datasets: [
                    {
                        label: 'Quantity',
                        data: merchant_data.quantity,
                        borderWidth: 1,
                        backgroundColor: merchant_data.color
                    },
                    // {
                    //     label: 'Price',
                    //     data: merchant_data.net_value,
                    //     borderWidth: 1,
                    //     backgroundColor: merchant_data.color
                    // }
                ]
