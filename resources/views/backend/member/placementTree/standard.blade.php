            ...
            <div class="page-head">
                <div class="container">
                    <div class="page-title">
                        <h1>{{__('dashboard.Standard Placement Tree')}}
                            <small></small>
                        </h1>
                    </div>
                </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        function listenPlacementTreeOnHover() {
            $('.memberData').hover(function () {
                if ($(this).attr('data-username') === undefined) {
                    return false;
                }
            ...
            if ($('#username').val() == "") {
                ...
                performAjaxCall('/member/ismember', 'GET', data, function (userId) {
                    if (userId != false) {
                        ...
                        performAjaxCall('/member/getStandardTree', 'GET', data, function (response) {
                            if (response != false) {
                                ...
                                $('#chart-container').orgchart({
                                   ...
                                   data-username="${names}">${data.name.substring(0, 10) + dotted}</a></div>`;
                                            ...
                                            return `  <div class="title"><a href="{{url('member/add-new-member?spill=')}}${data.spill}&placement=${data.placement}">${data.name}</a> </div>`;
